...
\begin{figure*}
  ...
  \caption{For Flownet, the output is a field of optical-flow vectors and visualized with a color field. Output for the Lucas-Kanade method is optical-flow vectors at keypoints in the images.}
