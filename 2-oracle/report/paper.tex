...
To improve the performance of the model, we add an ensemble network for CNN. (UNFINISHED)
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|}
		...
		TM ($\Delta=150$, NCCOR)    & 0.8475 & 0.7000 \\\hline
